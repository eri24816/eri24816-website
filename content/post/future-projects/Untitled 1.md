...
- grand / epic
- light / airy
- motivational / keeping going
- fluid / water-like
- crystal-like
- bubble like
- unleashing emotion/tension (typically after a build-up)
- choir (heavily polyphonic / using octaves for melody)
- half cadence / preparation for next section
- calm
- fat/thin
- unsure
I know these feelings are at least partially shared with some group of people because for example i listen to a music on youtube, get some feelings, and open comments to find similar feelings on other people.